...
//                 <div
//                   key={index}
//                   className={`h-8 w-8 rounded-full cursor-pointer transition-all duration-100 ${color}
//                     ${
//                       selectedColor === index
//                         ? "outline outline-white outline-4"
//                         : ""
...
import { toast } from "sonner";
import { IoArrowBack } from "react-icons/io5";
import { colors } from "@/lib/utils"; // Ensure this contains valid Tailwind classes
